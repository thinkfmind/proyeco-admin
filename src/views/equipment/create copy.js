...
const EquipmentCreate = () => {
  ...
  const onDrop2 = useCallback(acceptedFiles => {
    setFile([...file2, ...acceptedFiles])
  }, [file2])

  const onDrop3 = useCallback(acceptedFiles => {
    setFile([...file3, ...acceptedFiles])
  }, [file3])
  ...
  const onSubmit = async () => {
    ...
    if (
      ...
      try {
        ...
        formData.append("imagenUno", acceptedFiles[0]);
        formData.append("imagenDos", acceptedFiles2[0]);
        formData.append("imagenTres", acceptedFiles3[0]);
